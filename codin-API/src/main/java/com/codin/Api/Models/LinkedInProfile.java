...
public class LinkedInProfile implements Serializable {
    ...
    public Positionss getPositions() {
        return positions;
    }

    public void setPositions(Positionss positions) {
...
class Positionss implements Serializable {
...
class Countrys implements Serializable {
    private String code;
    private String name;
